...
import { Sparkles, User as UserIcon, Mail, Lock, UserPlus, AlertCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof msg === 'string') {
        ...
        setError("Registration failed. Please verify your details or try another email.");
      }
    } finally {
      setLoading(false);
    }
    ...
    <div className="max-w-md mx-auto py-12 animate-in fade-in duration-300">
      <div className="glass-panel rounded-3xl p-8 border border-slate-800 space-y-6 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Join AI Quiz Studio to extract & generate grounded study quizzes</p>
        </div>
        ...
        <p className="text-center text-xs text-slate-400">
          ...
          <Link to="/login" className="text-indigo-400 font-semibold underline">
            Sign In
          </Link>
        </p>
      </div>
